...
function useAdminEventRegistrations(
  ...
  return useQuery({
    ...
    queryFn: () =>
      getJson<{ success: true; data: AdminRegistrationsResponse }>(
          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="border-b text-left">
                ...
                <th className="p-2">{t("emergencyContact")}</th>
                  ...
                  <td className="p-2">
                    {r.emergencyContact ? (
                      <div className="text-xs">
                        <div>{r.emergencyContact.name}</div>
                        <div>{r.emergencyContact.phone}</div>
                        <div>{r.emergencyContact.email}</div>
                      </div>
                    ) : (
                      "—"
                    )}
