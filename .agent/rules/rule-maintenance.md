...
alwaysApply: true
description:
  Guidelines for adding/editing rules and workflows to keep single source of
  truth
---
...
> [!CAUTION] **NEVER** edit files directly in `.cursor/rules/` or
> `.cursor/commands/`. Always edit in `.agent/` — changes propagate
> automatically via junctions.
...
trigger: always_on alwaysApply: true description: Brief description of rule
purpose
